    ...
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-black bg-opacity-90 overflow-hidden relative">
      ...
      >
        <motion.div 
          ...
          className={`p-4 rounded-lg ${winner === player1 ? 'bg-blue-900 border-2 border-blue-500 shadow-lg shadow-blue-500/50' : 'bg-gray-800'}`}
        >
        ...
        <motion.div 
          whileHover={{ scale: 1.05 }}
          className={`p-4 rounded-lg ${winner === player2 ? 'bg-red-900 border-2 border-red-500 shadow-lg shadow-red-500/50' : 'bg-gray-800'}`}
        >
